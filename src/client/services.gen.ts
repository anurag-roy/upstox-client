...
import type { ConvertPositionsData, ConvertPositionsError, ConvertPositionsResponse, GetPositionsError, GetPositionsResponse, GetHoldingsError, GetHoldingsResponse2, ModifyOrderData2, ModifyOrderError, ModifyOrderResponse2, PlaceOrderData2, PlaceOrderError, PlaceOrderResponse2, GetTradesByOrderData, GetTradesByOrderError, GetTradesByOrderResponse, GetTradeHistoryError, GetTradeHistoryResponse, GetOrderBookError, GetOrderBookResponse2, GetOrderDetailsData, GetOrderDetailsError, GetOrderDetailsResponse, CancelOrderData2, CancelOrderError, CancelOrderResponse2, TokenData, TokenError, TokenResponse2, AuthorizeData, AutoLoginData, LogoutError, LogoutResponse2, GetProfileError, GetProfileResponse2, GetUserFundMarginData, GetUserFundMarginError, GetUserFundMarginResponse2, GetTradeWiseProfitAndLossMetaDataData, GetTradeWiseProfitAndLossMetaDataError, GetTradeWiseProfitAndLossMetaDataResponse2, GetTradeWiseProfitAndLossDataData, GetTradeWiseProfitAndLossDataError, GetTradeWiseProfitAndLossDataResponse2, GetProfitAndLossChargesData, GetProfitAndLossChargesError, GetProfitAndLossChargesResponse2, GetOptionContractsData, GetOptionContractsError, GetOptionContractsResponse, GetPutCallOptionChainData, GetPutCallOptionChainError, GetPutCallOptionChainResponse, GetExchangeTimingsData, GetExchangeTimingsError, GetExchangeTimingsResponse, GetMarketStatusData, GetMarketStatusError, GetMarketStatusResponse2, GetHolidaysError, GetHolidaysResponse, GetHolidayData, GetHolidayError, GetHolidayResponse2, GetFullMarketQuoteData, GetFullMarketQuoteError, GetFullMarketQuoteResponse2, GetMarketQuoteOhlcData, GetMarketQuoteOhlcError, GetMarketQuoteOhlcResponse, LtpData, LtpError, LtpResponse, GetHistoricalCandleDataData, GetHistoricalCandleDataError, GetHistoricalCandleDataResponse, GetHistoricalCandleData1Data, GetHistoricalCandleData1Error, GetHistoricalCandleData1Response, GetIntraDayCandleDataData, GetIntraDayCandleDataError, GetIntraDayCandleDataResponse, GetPortfolioStreamFeedData, GetPortfolioStreamFeedAuthorizeData, GetPortfolioStreamFeedAuthorizeError, GetPortfolioStreamFeedAuthorizeResponse, GetMarketDataFeedAuthorizeError, GetMarketDataFeedAuthorizeResponse, GetTradeHistory1Data, GetTradeHistory1Error, GetTradeHistory1Response, GetBrokerageData, GetBrokerageError, GetBrokerageResponse2 } from './types.gen';
...
export class TradeProfitAndLossService {
    ...
    public static getTradeWiseProfitAndLossMetaData(options: Options<GetTradeWiseProfitAndLossMetaDataData>) {
        return (options?.client ?? client).get<GetTradeWiseProfitAndLossMetaDataResponse2, GetTradeWiseProfitAndLossMetaDataError>({
            ...options,
...
export class WebsocketService {
    ...
    public static getPortfolioStreamFeedAuthorize(options?: Options<GetPortfolioStreamFeedAuthorizeData>) {
        return (options?.client ?? client).get<GetPortfolioStreamFeedAuthorizeResponse, GetPortfolioStreamFeedAuthorizeError>({
            ...options,
